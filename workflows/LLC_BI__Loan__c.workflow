...
ISPICKVAL(LLC_BI__Product_Line__c, &apos;Consumer&apos;)
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND(OR(LLC_BI__Auto_Decision_Status__c = &apos;Approved&apos;, LLC_BI__Auto_Decision_Status__c = &apos;Recommend Approval&apos;), Authorization_to_pull_credit__c = TRUE, 
ISPICKVAL(PRIORVALUE(LLC_BI__Stage__c),&quot;Qualification / Application&quot;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
